...
<!-- ======= book now Section ======= -->
<section id="contt" class="contact">
      <div class="container">

        <div class="section-title">
          <h2>Book for Appointment</h2>
          <p><i>booking for a lite package <span class="amount">KSH 1.00</span></i></p>
        ...
        <div class="form">
          <form action="booking.php" method="post" role="form" >
            ...
            <div class="row mt-2">
              ...
              <div class="col-md-6 form-group">
                <input type="text" name="service" class="form-control" id="phone" value="Lite package (Ksh 1200)" placeholder="Lite package (Ksh 1200)" data-rule="minlen:4" readonly>
              </div>
