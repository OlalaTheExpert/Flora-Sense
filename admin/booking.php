                                    ...
                                    <table class="table table-bordered table-striped">
										...
										?>
                                            ...
                                            <td><?php echo $row ['phone'];?>  
                                                <a href="tel:<?php echo $row ['phone'];?>"> </a>
                                            </td>
                                            ...
                                            <td>                                                
                                            <a title="Delete" href="include/cancel.php?id=<?php echo $row['booking_id']?>"  class="btn btn-danger btn-outline">Cancel </a>	
										
											 <a  title="Confirm" href="include/update.php?id=<?php echo $row['booking_id']?>"  class="btn btn-success btn-outline pt-3">Approve</a>	
                                            </td>
