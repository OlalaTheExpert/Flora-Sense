                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="client.php"><i class="menu-icon icon-user"></i> Client </a></li>
                                ...
                                <div class="module-body table">
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display"
										...
										?>
                                            ...
                                            <a title="Delete" href="delete_client.php?delete=<?php echo $row['customers_id']?>"  class="btn btn-danger btn-outline"><i class="fas fa-trash-alt"></i> Delete</a>	
										
											<a  title="Edit" href="edit_client.php?edit=<?php echo $row['customers_id']?>"  class="btn btn-success btn-outline"><i class="fas fa-pencil-alt"></i> Edit</a>	
                                            </td>
                                        </tr>
                                        <?php } ?>
                                        </tbody>
