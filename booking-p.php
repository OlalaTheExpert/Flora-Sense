...
<section id="conta" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p><i>booking for a Premium package<span class="amount">KSH 1.00</span></i></p>
        ...
        <div class="form">
          <form action="booking.php" method="post" role="form">
            ...
            <input type="hidden" name="amount" class="form-control" id="amount" value="1">
              ...
              <div class="col-md-6 form-group">
                <input type="text" name="service" class="form-control" id="phone" value="Premium package (Ksh 2300)" placeholder="Premium package (Ksh 2300)" data-rule="minlen:4" readonly>
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-md-6 form-group">
